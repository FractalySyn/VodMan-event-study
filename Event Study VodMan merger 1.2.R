...
event4 = c("2000-01-11", "2000-01-12", "2000-01-13") # remove 10/01/2000 for Mannesmann
event_list_mann = list(event1, event2, event3, event4, event5, event6, event7, event8)
...
# Vodafone
event_study(datav, ewv0, period_vod, "capm", bootstrap_X)
event_study(datav, ewv0, period_vod, "cmrm", bootstrap_X)
event_study(datav, ewv0, period_vod, "b-one", bootstrap_X)
...
# Mannesmann
event_study(datam0, ewm0, mann_phases, "capm", bootstrap_X)
event_study(datam0, ewm0, mann_phases, "cmrm", bootstrap_X)
event_study(datam0, ewm0, mann_phases, "b-one", bootstrap_X)

# Vodafone
event_study(datav, ewv0, vod_phases, "capm", bootstrap_X)
event_study(datav, ewv0, vod_phases, "cmrm", bootstrap_X)
event_study(datav, ewv0, vod_phases, "b-one", bootstrap_X)
